...
<div class="page-heading">
     <h3>@yield('page-title')</h3> {{-- Judul Halaman Content  --}} 
</div> 
<div class="page-content"> 
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="col-3">
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-md">
                                                        <img src="{{ asset("template/dist") }}/assets/compiled/jpg/8.jpg">
                                                    </div>
                                        ...
                                        <tr>
                                            <td class="col-3">
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-md">
                                                        <img src="{{ asset("template/dist") }}/assets/compiled/jpg/3.jpg">
                                                    </div>
    ...
    <!-- jQuery dari Bootstrap 5 untuk Datatables JS -->
