                        ...
                        <td>
                            <div class="buttons">
                                ...
                                <form action="{{ route('admin.pendidikan.destroy', $d['id'] )}}" method="POST" style="display:inline;">
                                    ...
                                    <button class ="btn icon btn-danger" type="submit" onclick="return confirm('Apakah anda yakin ingin menghapus {{ $d['jenjang_pendidikan']}} ?')"><i class="bi bi-trash3"></i></button>
                                </form>
                            </div>
                        </td>
                    </tr>
