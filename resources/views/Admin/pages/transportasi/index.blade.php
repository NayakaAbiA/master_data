                            ...
                            <td>
                                <div class="buttons">
                                    ...
                                    <form action="{{ route('admin.transportasi.destroy',  $item['id'] )}}" method="POST" style="display:inline;">
                                        ...
                                        <button class ="btn icon btn-danger" type="submit" onclick="return confirm('Apakah anda yakin ingin menghapus {{ $item['alat_transport'] }} ?')"><i class="bi bi-trash3"></i></button>
                                    </form>
                                </div>
                            </td>
                        </tr>
