                    ...
                    <tr>
                        ...
                        <td>
                            <div class="buttons">
                                ...
                                <a class="btn icon btn-primary" href="{{ route('admin.rombel.edit',  ['rombel' => $item->id ] )}}"><i class="bi bi-pencil-square"></i></a>
                                <form action="{{ route('admin.rombel.destroy',  ['rombel' => $item->id ] )}}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
