...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            ...
            <a class="btn btn-success" href="{{ url('/export-pegawai') }}">Export data ke Excel</a>
        </div>
        <div class="card-body">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="buttons">
                                ...
                                <a class="btn icon btn-primary" href="{{ route('admin.pegawai.edit',  $p['id']  )}}"><i class="bi bi-pencil-square"></i></a>
