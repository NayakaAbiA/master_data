    ...
    <div class="card col-md-12">
        <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-2">
            <div class="d-flex align-items-center flex-wrap gap-2">
                <h5 class="card-title mb-0">Tambah Provinsi</h5>

                <button type="button" class="btn btn-success" data-bs-toggle="modal"
                    data-bs-target="#inlineFormPegawai">Import Data</button>

                <a href="{{ route('admin.provinsi.downloadTemplate') }}" class="btn btn-success">Unduh Template Excel</a>
            </div>
        </div>
        ...
        <div class="modal fade text-left" id="inlineFormPegawai" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('admin.provinsi.import') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" value="{{ old('provinsi') }}" id="provinsi" name="provinsi"
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" value="{{ old('ibu_kota') }}" id="ibu_kota" name="ibu_kota"
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" value="{{ old('p_bsni') }}" id="p_bsni" name="p_bsni"
