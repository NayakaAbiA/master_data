<div class="form-body mt-2" id="domisili" role="tabpanel" aria-labelledby="domisili-tab">
    <div class="row">
        <div class="col-md-4"><label for="Jalan">Alamat</label></div>
        ...
        <div class="col-md-4"><label for="no_rumah">No Rumah</label></div>
        <div class="col-md-8 form-group">
        ...
        <div class="col-md-4"><label for="RT">RT</label></div>
        <div class="col-md-8 form-group">
        ...
        <div class="col-md-4"><label for="RW">RW</label></div>
        <div class="col-md-8 form-group">
        ...
        <div class="col-md-4"><label for="lintang">Lintang</label></div>
        <div class="col-md-8 form-group">
        ...
        <div class="col-md-4"><label for="bujur">Bujur</label></div>
        <div class="col-md-8 form-group">
        ...
        <div class="col-md-4"><label for="no_telepon">No Telepon Rumah</label></div>
        <div class="col-md-8 form-group">
        ...
        <div class="col-md-4"><label for="id_jns_tgl">Jenis Tinggal</label></div>
        <div class="col-md-8 form-group">
        ...
        <div class="col-md-4"><label for="id_transport">Transportasi</label></div>
        <div class="col-md-8 form-group">
