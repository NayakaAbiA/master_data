<div class="form-body mt-2" id="lainnya" role="tabpanel" aria-labelledby="lainnya-tab">
    <div class="row">
    <div class="col-md-4">
        ...
        <div class="col-md-8 form-group">
            ...
            @error('no_skhun') <div class="invalid-feedback">{{ $message }}</div> @enderror
        </div>
        ...
        <div class="col-md-8 form-group">
            ...
            @error('nopes_un') <div class="invalid-feedback">{{ $message }}</div> @enderror
        </div>
        ...
        <div class="col-md-8 form-group">
            ...
            @error('no_seri_ijazah') <div class="invalid-feedback">{{ $message }}</div> @enderror
        </div>
        ...
        <div class="col-md-8 form-group">
            ...
            @error('nama_pada_kartu') <div class="invalid-feedback">{{ $message }}</div> @enderror
        </div>
        ...
        <div class="col-md-8 form-group">
            ...
            @error('id_bank') <div class="invalid-feedback">{{ $message }}</div> @enderror
        </div>
        ...
        <div class="col-md-8 form-group">
            ...
            @error('no_rek_bank') <div class="invalid-feedback">{{ $message }}</div> @enderror
        </div>
        ...
        <div class="col-md-8 form-group">
            ...
            @error('rek_atas_nama') <div class="invalid-feedback">{{ $message }}</div> @enderror
        </div>
        ...
        <div class="col-md-8 form-group">
            ...
            @error('layak_bantuan') <div class="invalid-feedback">{{ $message }}</div> @enderror
        </div>
        ...
        <div class="col-md-8 form-group">
            ...
            @error('id_prgbantuan') <div class="invalid-feedback">{{ $message }}</div> @enderror
        </div>
        ...
        <div class="col-md-8 form-group">
            ...
            @error('alasan_layak') <div class="invalid-feedback">{{ $message }}</div> @enderror
        </div>
        ...
        <div class="col-md-8 form-group">
            ...
            @error('Stat_siswa') <div class="invalid-feedback">{{ $message }}</div> @enderror
        </div>
