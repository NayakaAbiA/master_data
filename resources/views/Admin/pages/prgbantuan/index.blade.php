                    ...
                    <tr>
                        ...
                        <td>
                            <div class="buttons">
                                ...
                                <a class="btn icon btn-primary" href="{{ route('admin.prgbantuan.edit',  ['prgbantuan' => $d->id ] )}}"><i class="bi bi-pencil-square"></i></a>
                                <form action="{{ route('admin.prgbantuan.destroy',  ['prgbantuan' => $d->id ] )}}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
